...
opp_run -u Cmdenv -m -n ../../..:../../../../examples   -l ../../../INET -f ../omnetpp2.ini -c General -r "\$FatTreeSize==$(printf '%d' $1)  &&  \$numShortFlows==$(printf '%d' $2)"
...
cat instThroughput.csv | cut -d, -f13  | sed "1 d" > MatInstThroughput.csv
...
cat config.csv | cut -d, -f13  | sed "1 d" > MatConfig.csv
