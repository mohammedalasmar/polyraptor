...
#../../FatTree -u Cmdenv  -m  -n ../..:../../../inet/src -l ../../../inet/src/INET -f  ../centralSch.ini  -c General -r   "\$FatTreeSize==$(printf '%d' $1)  &&  \$numShortFlows==$(printf '%d' $2)"
#../../FatTree -u Cmdenv  -m  -n ../..:../../../inet/src -l ../../../inet/src/INET -f  ../centralSch.ini  -c General   -q runs
opp_run -u Cmdenv -m -n ../../..:../../../../examples   -l ../../../INET -f ../centralSch.ini -c General -r "\$FatTreeSize==$(printf '%d' $1)  &&  \$numShortFlows==$(printf '%d' $2)"
