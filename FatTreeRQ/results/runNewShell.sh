...
#../../raptorqimplementation -u Cmdenv  -m  -n ../..:../../../inet/src -l ../../../inet/src/INET -f  ../centralSchRq.ini  -c General -r    "\$FatTreeSize==$(printf '%d' $1)  &&  \$numShortFlows==$(printf '%d' $2)"


#opp_run -u Cmdenv -m -n ../../..:../../../../examples   -l ../../../INET -f ../omnetpp4.ini -c General -r "\$FatTreeSize==$(printf '%d' $1)  &&  \$numShortFlows==$(printf '%d' $2)"


opp_run  -u Cmdenv -m -n ../../../..:../../../../../examples:../../../../../tutorials -l ../../../../INET ../centralSchRq.ini -c General -r "\$FatTreeSize==$(printf '%d' $1)  &&  \$numShortFlows==$(printf '%d' $2)"
...
echo "FCT"
scavetool export -T s -f "module(**.raptorQApp[*]) AND ("fctRecordv2:last")"   -F CSV-S -o fct.csv *.sca
echo "   "
...
scavetool export -T v -f 'module(FaFatTree.centralScheduler) AND name(permMapLongFlowsVec)'  -F CSV-R -o longFlowsNodes.csv  *.vec
