...
#ifndef __INET_RQMSGBASEDRCVQUEUE_H
#define __INET_RQMSGBASEDRCVQUEUE_H
 ...
 */
class INET_API RQMsgBasedRcvQueue : public RQVirtualDataRcvQueue
{
  protected:
    struct PayloadItem
    {
...
#endif // ifndef __INET_RQMSGBASEDRCVQUEUE_H
