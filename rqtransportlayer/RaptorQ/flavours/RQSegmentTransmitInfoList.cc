...
#include "RQSegmentTransmitInfoList.h"

namespace inet {

namespace raptorq {

void RQSegmentTransmitInfoList::set(uint32_t beg, uint32_t end, simtime_t sentTime)
{
...
const RQSegmentTransmitInfoList::Item *RQSegmentTransmitInfoList::get(uint32_t seq) const
{
...
void RQSegmentTransmitInfoList::clearTo(uint32_t endseq)
{
